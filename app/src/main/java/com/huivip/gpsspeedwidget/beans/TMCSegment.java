...
public class TMCSegment {
    ...
    public TMCSegment setTmc_segment_enabled(boolean tmc_segment_enabled) {
    ...
    public TMCSegment setTmc_segment_size(int tmc_segment_size) {
    ...
    public TMCSegment setTotal_distance(int total_distance) {
    ...
    public TMCSegment setResidual_distance(int residual_distance) {
    ...
    public TMCSegment setFinish_distance(int finish_distance) {
    ...
    public TMCSegment setTmc_info(List<TmcInfo> tmc_info) {
