package com.huivip.gpsspeedwidget.lyrics.model;
...
import static com.huivip.gpsspeedwidget.lyrics.model.LyricsTag.TAG_ARTIST;
import static com.huivip.gpsspeedwidget.lyrics.model.LyricsTag.TAG_BY;
import static com.huivip.gpsspeedwidget.lyrics.model.LyricsTag.TAG_OFFSET;
import static com.huivip.gpsspeedwidget.lyrics.model.LyricsTag.TAG_TITLE;
import static com.huivip.gpsspeedwidget.lyrics.model.LyricsTag.TAG_TOTAL;
...
public class LyricsInfo {
    ...
    public void setTitle(String title) {
        ...
        mLyricsTags.put(TAG_TITLE, title);
    ...
    public String getTitle() {
        ...
        if (mLyricsTags != null && !mLyricsTags.isEmpty()
                && mLyricsTags.containsKey(TAG_TITLE)) {
            title = (String) mLyricsTags.get(TAG_TITLE);
        }
        return title;
    ...
    public void setArtist(String artist) {
        ...
        mLyricsTags.put(TAG_ARTIST, artist);
    }
    ...
    public String getArtist() {
        ...
        String artist = "";
        if (mLyricsTags != null && !mLyricsTags.isEmpty()
                && mLyricsTags.containsKey(TAG_ARTIST)) {
            artist = (String) mLyricsTags.get(TAG_ARTIST);
        }
        return artist;
    ...
    public void setOffset(long offset) {
        ...
        mLyricsTags.put(TAG_OFFSET, offset);
    }
    ...
    public long getOffset() {
        ...
        long offset = 0;
        if (mLyricsTags != null && !mLyricsTags.isEmpty()
                && mLyricsTags.containsKey(TAG_OFFSET)) {
            try {
    ...
    public String getBy() {
        ...
        String by = "";
        if (mLyricsTags != null && !mLyricsTags.isEmpty()
                && mLyricsTags.containsKey(TAG_BY)) {
            by = (String) mLyricsTags.get(TAG_BY);
        }
        return by;
    ...
    public void setTotal(long total) {
        ...
        mLyricsTags.put(TAG_TOTAL, total);
    }
    ...
    public long getTotal() {
        ...
        long total = 0;
        if (mLyricsTags != null && !mLyricsTags.isEmpty()
                && mLyricsTags.containsKey(TAG_TOTAL)) {
            try {
