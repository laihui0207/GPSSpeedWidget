package com.huivip.gpsspeedwidget.lyrics.widget;
...
import com.huivip.gpsspeedwidget.lyrics.model.LyricsInfo;
import com.huivip.gpsspeedwidget.lyrics.model.LyricsLineInfo;
import com.huivip.gpsspeedwidget.lyrics.utils.ColorUtils;
import com.huivip.gpsspeedwidget.lyrics.utils.LyricsUtils;
...
public abstract class AbstractLrcView extends View {
    ...
    private void init(Context context) {
       ...
       // RegisterHelper.verify();
        ...
        //初始默认数据
        mDefText = "Music";//context.getString(R.string.def_text);
        mLoadingText ="Loading";// context.getString(R.string.loading_text);
        mLoadErrorText ="Error"; //context.getString(R.string.load_error_text);
        mNonsupportText = "No support";//context.getString(R.string.nonsupport_text);
        mGotoSearchText ="Searching"; //context.getString(R.string.goto_search_text);
