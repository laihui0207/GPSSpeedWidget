...
public abstract class PrefUtils {
    ...
    public static String getPrefOverSpeedTts(Context context){
        return getSharedPreferences(context).getString(PREF_OVER_SPEED_TTS, Constant.OVER_SPEED_TTS);
    }
    ...
    public static boolean isShowNotification(Context context) {
        ...
        return getSharedPreferences(context).getBoolean(SPEED_SHOW_NOTIFICATION, defaultValue);
    }
