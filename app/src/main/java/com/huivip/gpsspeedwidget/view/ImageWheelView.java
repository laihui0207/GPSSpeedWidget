...
public class ImageWheelView extends ImageView
{
    private Resources mResources;
    Paint mBorderPaint = new Paint(1);

    public ImageWheelView(Context paramContext)
    {
        this(paramContext, null);
    }

    public ImageWheelView(Context paramContext, AttributeSet paramAttributeSet)
    {
